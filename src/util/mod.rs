...
pub fn parse_args() -> ArgMatches<'static> {
	let save_settings = SubCommand::with_name("save")
	...
	let gif_settings = SubCommand::with_name("gif")
		...
		.subcommand(save_settings);
	let record_settings = SubCommand::with_name("record")
